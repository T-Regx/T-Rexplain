<?php
namespace Test\TRegx\Analyze\Simplify;

use PHPUnit\Framework\TestCase;
use TRegx\Analyze\Simplify\PatternSimplifier;
...
class PatternSimplifierTest extends TestCase
{
    ...
    {
        // given
        $simplifier = new PatternSimplifier($complex);
    ...
    {
        // given
        $simplifier = new PatternSimplifier($escaped);
    ...
    {
        // given
        $simplifier = new PatternSimplifier('invalid (a|');
...
//        $this->expectException(InvalidPatternException::class);
    ...
    public function shouldSimplify_multipleEscaping()
    {
        ...
        $simplifier = new PatternSimplifier("$escaped{1,}");
