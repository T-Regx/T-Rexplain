...
Handy `require-dev` debug and analyze tool for working with regular expressions.

It allows you to debug, analyze and simplify your regular expressions!
...
```bash
$ composer require --dev rawr/explain
```
